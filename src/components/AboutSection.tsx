  ...
  return (
    <section className="py-20 bg-[var(--bg-primary)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <Badge className="mb-4 bg-[var(--accent-primary)]/10 text-[var(--accent-primary)] border-[var(--accent-primary)]/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="prose prose-lg text-[var(--text-secondary)] leading-relaxed">
              <p className="text-xl font-medium text-[var(--text-primary)] mb-6">
          ...
          >
            <div className="relative">
              <motion.div
                ...
                className="bg-[var(--bg-surface)] rounded-full p-8 shadow-2xl border border-[var(--bg-elevated)]"
              >
                <img 
                  src={calangoicone} 
                  alt="CalangoFlux" 
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 bg-[var(--accent-primary)] rounded-full p-3 shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -left-4 bg-[var(--accent-secondary)] rounded-full p-3 shadow-lg"
              >
        ...
        >
          <div className="prose prose-lg text-[var(--text-secondary)] leading-relaxed mx-auto">
            <p className="text-xl font-medium text-[var(--text-primary)] mb-6">
        ...
        <motion.div
          ...
          className="bg-[var(--bg-surface)] border border-[var(--bg-elevated)] rounded-2xl p-8 md:p-12 mb-16"
        >
          <h3 className="text-2xl md:text-3xl font-bold text-[var(--text-primary)] text-center mb-8">
            O Nome?
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="text-center">
              <motion.div
                ...
                className="bg-[var(--bg-primary)] border border-[var(--bg-elevated)] rounded-xl p-6 shadow-lg mb-4"
              >
                <TreePine className="w-12 h-12 text-[var(--accent-primary)] mx-auto mb-4" />
                <h4 className="text-xl font-bold text-[var(--text-primary)] mb-2">Calango</h4>
            ...
            <div className="text-center">
              <motion.div
                ...
                className="bg-[var(--bg-primary)] border border-[var(--bg-elevated)] rounded-xl p-6 shadow-lg mb-4"
              >
                <Waves className="w-12 h-12 text-[var(--accent-secondary)] mx-auto mb-4" />
                <h4 className="text-xl font-bold text-[var(--text-primary)] mb-2">Flux</h4>
                <p className="text-[var(--text-secondary)]">
